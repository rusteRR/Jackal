...
void jackal::Game::process_move(int col_from, int row_from, int col_to, int row_to) {
...
void jackal::Game::check_move_correctness(int col_from, int row_from, int col_to, int row_to) {
